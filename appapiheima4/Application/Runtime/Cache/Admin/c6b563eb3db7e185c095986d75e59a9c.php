...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<div class="container">
		...
		<form action="/appapiheima4/index.php/Admin/News/update" method="post" class="form-horizontal" enctype="multipart/form-data">
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
			      <img src = '/appapiheima4/<?php echo ($vo["image"]); ?>' width="56" height="44">
			    </div>
			</div>
			<!-- <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
			      <!-- 加载编辑器的容器 -->
			      				    ...
			      				    <!-- 配置文件 -->
			      				    <script type="text/javascript" src="/appapiheima4/Public/js/ueditor/ueditor.config.js"></script>
			      				    <!-- 编辑器源码文件 -->
			      				    <script type="text/javascript" src="/appapiheima4/Public/js/ueditor/ueditor.all.js"></script>
			      				    <!-- 实例化编辑器 -->
			      				    <script type="text/javascript">
